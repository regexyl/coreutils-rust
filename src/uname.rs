...
unsafe extern "C" fn print_element_env(
    mut element: *const libc::c_char,
    mut envvar: *const libc::c_char,
) {
            ...
            | 16 as libc::c_int) as libc::c_uint != 0
    {
        ...
        if toprint & 1 as libc::c_int as libc::c_uint != 0 {
            print_element_env(
                ...
                b"UNAME_SYSNAME\0" as *const u8 as *const libc::c_char,
            );
        }
        if toprint & 2 as libc::c_int as libc::c_uint != 0 {
            print_element_env(
                (name.nodename).as_mut_ptr(),
                b"UNAME_NODENAME\0" as *const u8 as *const libc::c_char,
            );
        }
        if toprint & 4 as libc::c_int as libc::c_uint != 0 {
            print_element_env(
                (name.release).as_mut_ptr(),
                b"UNAME_RELEASE\0" as *const u8 as *const libc::c_char,
            );
        }
        if toprint & 8 as libc::c_int as libc::c_uint != 0 {
            print_element_env(
                (name.version).as_mut_ptr(),
                b"UNAME_VERSION\0" as *const u8 as *const libc::c_char,
            );
        }
        if toprint & 16 as libc::c_int as libc::c_uint != 0 {
            print_element_env(
                (name.machine).as_mut_ptr(),
                b"UNAME_MACHINE\0" as *const u8 as *const libc::c_char,
            );
        }
    }
