...
pub const REFERENCE_FILE_OPTION: C2RustUnnamed_0 = 260;
pub const PRESERVE_ROOT: C2RustUnnamed_0 = 259;
pub const NO_PRESERVE_ROOT: C2RustUnnamed_0 = 258;
pub const FROM_OPTION: C2RustUnnamed_0 = 257;
...
pub unsafe extern "C" fn usage(mut status: libc::c_int) {
    if status != 0 as libc::c_int {
        ...
        fputs_unlocked(
            dcgettext(
                0 as *const libc::c_char,
                b"      --reference=RFILE  use RFILE's owner and group rather than specifying\n                         OWNER:GROUP values.  RFILE is always dereferenced.\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            stdout,
...
unsafe fn main_0(
    ...
    loop {
        ...
        match optc {
            ...
            257 => {
                ...
                let mut e: *const libc::c_char = parse_user_spec_warn(
                    optarg,
                    &mut required_uid,
                    &mut required_gid,
    ...
    if !reference_file.is_null() {
        ...
        let mut e_0: *const libc::c_char = parse_user_spec_warn(
